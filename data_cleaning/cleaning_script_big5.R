...
pop_by_sex3 <- pop_by_sex2 %>%
  ...
  dplyr::filter(site_id %notin% c("NA?`?p",
                                  "NA??????",
                                  "?s?_???s?_??",
                                  "?x?_???x?_??",
                                  "????????????",
...
####################################################################################
#####
####          Save files to shiny data directory   
########
#################################################################################
save(inc_by_A, file = "./Taiwan_Covid_by_dist/data/inc_by_A.rda") 
save(inc_by_D, file = "./Taiwan_Covid_by_dist/data/inc_by_D.rda") 
